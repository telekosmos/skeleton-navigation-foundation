...
__Note__ ([__LIVE DEMO__](http://telekosmos.github.io/skeleton-navigation-foundation/)) *This is a modified vesion of [aurelia-skeleton-navigation](http://github.com/aurelia/skeleton-navigation) using [Zurb Foundation 5.5](https://github.com/zurb/foundation) as replacement for the 'default' [Bootstrap 3.4](https://github.com/twbs/bootstrap) CSS framework used in the original skeleton and shows the use of another framework along with some JS components ([Reveal Modal](http://foundation.zurb.com/docs/components/reveal.html) and [Top Bar](http://foundation.zurb.com/docs/components/topbar.html) in this case)*.
## Running The App
