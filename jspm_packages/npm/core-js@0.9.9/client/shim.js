  ...
  !function(undefined) {
    ...
    (function(modules) {
      ...
      if (!useNative) {
        ...
        if ($.DESC && $.FW)
          $.hide(Object.prototype, 'propertyIsEnumerable', propertyIsEnumerable);
      }
      var symbolStatics = {
        'for': function(key) {
      ...
      'use strict';
      var $def = __webpack_require__(50),
          $at = __webpack_require__(66)(false);
      ...
      var $def = __webpack_require__(50);
      $def($def.P, 'String', {repeat: __webpack_require__(69)});
    }, function(module, exports, __webpack_require__) {
      'use strict';
      var $ = __webpack_require__(49),
          cof = __webpack_require__(53),
      ...
      __webpack_require__(68)(Array, 'Array', function(iterated, kind) {
        $.set(this, ITER, {
          o: $.toObject(iterated),
          i: 0,
          k: kind
      ...
      function setStatics(keys, length) {
        $.each.call(keys.split(','), function(key) {
          if (length == undefined && key in $Array)
            ...
            statics[key] = __webpack_require__(70)(Function.call, [][key], length);
        });
      }
      ...
      module.exports = {
        ...
        setIter: function(C, NAME, IS_MAP) {
          __webpack_require__(68)(C, NAME, function(iterated, kind) {
            set(this, ITER, {
              o: iterated,
              k: kind
            });
